from dnachisel import (random_dna_sequence, sequence_to_biopython_record,
                       DnaNotationPattern)
from dnachisel.biotools.features_annotations import (
    annotate_record, annotate_differences, annotate_pattern_occurrences)
...
def test_annotate_record():
    ...
    annotate_record(random_rec, location=(10, 50), feature_type="CDS",
                    label='my_label')
