...
class NucleotideContent(Specification):
    ...
    def __init__(
        ...
        self.sequence = solution.sequence[self.ntcontent_range[0]:self.
                                          ntcontent_range[1] + 1]
        self.mutable_region = args.get('mutable_region',
                                       solution.mutable_region)
    ...
    def set_scores(self, scoring_function=analyze_ntcontent):
        self.scores = appendLabelToDict(scoring_function(self.sequence),
                                        self.label)
...
class NucleotideContentAT(NucleotideContent):
    ...
    def __init__(
        ...
        NucleotideContent.__init__(self,
                                   solution=solution,
                                   label=label,
                                   args=args)
